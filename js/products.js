...
(function () {
  ...
  var ASEED_PRODUCTS = [
    ...
    /* ---- SHIRT ×3 (p10–p12) ---- */
    {
      ...
      no: 10,
      line: 3,
      name: "FOUR-STITCH POPLIN SHIRT",
      nameJa: "フォーステッチ ポプリンシャツ",
      category: "shirt",
      price: 28600,
      colors: ["WHITE"],
      sizes: ["1", "2", "3"],
      desc: "背中に残された四つのステッチは、外されたラベルの記憶。名前のない白いシャツが、着る人の輪郭だけを語る。",
      isNew: true,
    ...
    /* ---- ACCESSORY ×1 (p24) ---- */
    {
      ...
      no: 24,
      line: 8,
      name: "FOUR-STITCH SILVER RING",
      nameJa: "フォーステッチ シルバーリング",
      category: "accessory",
      price: 18700,
      colors: ["GREY"],
      sizes: ["FREE"],
      desc: "四つのステッチを、銀の表面に刻印として移植した。糸は金属になっても、縫い留めるという意志を忘れない。",
      isNew: true,
